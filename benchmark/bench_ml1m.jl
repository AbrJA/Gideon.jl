...
function benchmark_ials(X_train, X_test; rank=64, n_iter=15, α=40.0, λ=0.1, solver=:cg)
    println("─" ^ 70)
...
for rank in [32, 64]
    results["iALS_CG_r$rank"] = benchmark_ials(X_train, X_test; rank=rank, solver=:cg)
end
